        ...
        <div className="hero-container">
          <div className="hero-content">
            <h1 className="hero-title">
              <span>Share & Grow with</span>
              <span className="highlight">LearnVibe</span>
            </h1>
            <p className="hero-description">
              Join a dynamic community to share skills like coding, cooking, and
              more. Create learning plans, track progress, and connect through
      ...
      <div id="features" className="features-section">
        <div className="features-container">
          <div className="features-header">
            <h2 className="features-title">Why Choose LearnVibe?</h2>
            <p className="features-description">
              Explore features designed to make your learning journey vibrant
              and engaging.
            </p>
          </div>
          ...
          <div className="features-grid">
            ...
            <div className="feature-card">
              ...
              <p className="feature-description">
                Showcase your skills, posts, and learning journey on a
            ...
            <div className="feature-card">
              ...
              <p className="feature-description">
                Receive real-time updates for likes, comments, and follows on
                your posts.
              </p>
            </div>
            ...
            <div className="feature-card">
              ...
              <p className="feature-description">
                Log in securely using social media accounts with OAuth 2.0
                authentication.
              </p>
            </div>
          </div>
      ...
      <div id="about" className="about-section">
        <div className="about-container">
          <div className="about-header">
            <h2 className="about-title">About LearnVibe</h2>
            <p className="about-description">
              LearnVibe is your platform for learning, sharing, and growing in a
          ...
          <div className="about-content">
            <p>
              ...
              crafts, LearnVibe empowers you to share your expertise and learn
              from others. Create structured learning plans, track your
              progress, and engage with a vibrant community through likes,
              comments, and follows. Join us today and start your learning
              journey!
            </p>
